...
a{text-decoration:none;color:black;}
  ...
  <div id="WebProduct">
    <div id="ProductImageInfo" class="ViewCard">
      <div id="ProductImage">
      <a href="SingleProduct.html?id=" id="eventForSungleProduct">  <img src="" id=""/></a>
      </div>
      <div id="ProductInfo">
          <h1 id="">  <a href="SingleProduct.html?id=" id="eventForSungleProduct"><slot name="name"/></a></h1>
        <h3  >  <a href="SingleProduct.html?id=" id="eventForSungleProduct"><slot name="prix"/></a></h3>
        <hr>
  ...
  export default class item extends HTMLElement{
    ...
    //for change a href to pridcut Single Page
    changeLinkHref(){
this.shadowRoot.querySelectorAll("#eventForSungleProduct").forEach((item, i) => {
              item.href+=this.getAttribute("NumberId");
});
